...
for page in range(1, pages_to_fetch + 1):
    url = f"https://note.com/api/v3/mkit_layouts/json"
    params = {
        "context": "editor_pickup",
        "page": page
    }
        ...
        try:
            ...
            if raw_body:
                ...
                for line in lines:
                    ...
                    # 基礎過濾
                    if len(t) < 2 or t == author or t == title: continue
...
target_folder = r"E:\AI-project\日文爬蟲"
